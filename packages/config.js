const ChartConfig = [
	...
	{ category: 0, id: '1012', name: 'g2-bar-line', icon: 'icon-chart-bar-line', tooltip: '柱形图+折线', dimension: 1, line: 1, width: 260, height: 180 },
	{ category: 0, id: '1011', name: 'g2-bar-h', icon: 'icon-chart-bar-h', tooltip: '柱形图(水平)', legend: 1 },
	{ category: 0, id: '1020', name: 'g2-bar-dodge', icon: 'icon-chart-dodge-v', tooltip: '分组柱形图', legend: 1 },
	...
	{ category: 0, id: '1050', name: 'g2-line', icon: 'icon-chart-line', tooltip: '折线图', legend: 1 },
	{ category: 0, id: '1051', name: 'g2-point', icon: 'icon-chart-point', tooltip: '散点图', z: 1, legend: 1},
	...
	{ category: 0, id: '1090', name: 'g2-tag-cloud', icon: 'icon-chart-tag-cloud', tooltip: '词云', dimension: 1 },
...
const UiConfig = [
	...
	{ category: 2, id: '301', name: 'ui-layout', icon: 'icon-ui-layout', tooltip: '容器', width: 260, height: 180 }
]
